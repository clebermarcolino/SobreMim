...
Este projeto é uma página web pessoal desenvolvida para apresentar informações sobre mim.
...
Como este é um projeto de página web estática, a instalação é bastante simples:
